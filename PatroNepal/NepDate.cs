...
namespace PatroNepal{
    class NepDate{
       ...
       //int iny, inm, ind;
        int iey, iem, ied, iew; // initial dates
        
        public int GetFirstDay(int y, int m){
            int wd = iew;
            int xm = 13;
        ...
        public NepDate(){
            //iny = 2000; inm = 1; ind = 1;
            iey = 1943; iem = 4; ied = 14; iew = 3 /*wednesday*/ ;
        ...
        public void ConvertFromEng(int ey, int em, int ed, ref int ny, ref int nm, ref int nd){
            DateTime idt = new DateTime(iey, iem, ied);
            DateTime dt = new DateTime(ey, em, ed);

            int ndays = (dt - idt).Days;
            nd = ndays + 1;
            int i=0, j=1;
            for (i = 0; i <= 90; i++){
                for (j = 1; j <= 12; j++){
        ...
        public void ConvertToEng(ref int ey, ref int em, ref int ed, int ny, int nm, int nd){
            DateTime dt = new DateTime(iey, iem, ied);
